...
switch ($_SERVER['REQUEST_METHOD']) {
    case 'POST':
        ...
        include_once "create_competizione.php";
        break;
        
    case 'GET':

        if(isset($id)) include_once "read_competizione.php";
        include_once "read_competizioni.php";
    ...
    case 'PUT':
        ...
        include_once "update_competizione.php";
    ...
    case 'DELETE':
        ...
        if(isset($id)) include_once "delete_competizione.php";
